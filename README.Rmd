...
> NOTE: This package is super raw. It's a shell of some 
functions that work for an immediate need of mine but needs 
a good bit of polishing. `msgraphr` is posted for public 
consumption in the hope that it may be of use to some as 
I'm time-blocked on putting much effort into this right 
now. PRs  o polish the package are **most** welcome.
